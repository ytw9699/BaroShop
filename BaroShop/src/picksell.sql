...
alter table ps_orderlist drop (deleted); 

ALTER TABLE PS_MEMBER DROP COLUMN phoneNum;--테이블 컬럼 삭제
...
CREATE TABLE PS_CATEGORY (
    ...
    CATEGORY_IMG VARCHAR2(50) 
);

insert into PS_CATEGORY(CATEGORY_NUM,
					CATEGORY_NAME
					 ) values(
							1,
							'전자제품'
...
UPDATE PS_CATEGORY SET CATEGORY_IMG = '10.png' WHERE CATEGORY_NUM = 10;
...
CREATE TABLE PS_PRODUCT(
    ...
    PRODUCT_REGDATE DATE NOT NULL,
    DEAL_STATUS VARCHAR2(10) DEFAULT '0' NOT NULL ,
    BOARD_STATUS VARCHAR2(10) DEFAULT '0' NOT NULL ,
    CONTENT VARCHAR2(4000) NOT NULL,
    FIRST_IMG VARCHAR2(100) DEFAULT '0',
    SUBJECT VARCHAR2(1000) NOT NULL,
    PRODUCT_STATUS VARCHAR2(10) NOT NULL,
...
CREATE TABLE PS_FREE_BOARD(
    ...
    FB_REGDATE DATE NOT NULL,
    FB_CONTENT VARCHAR2(4000) NOT NULL,
    FB_HITCOUNT NUMBER DEFAULT '0' NOT NULL 
);
...
CREATE TABLE PS_ALARM( 
    ...
    ALARM_VARIABLE1 VARCHAR2(10) NOT NULL,
    ALARM_VARIABLE2 VARCHAR2(10) NOT NULL,
